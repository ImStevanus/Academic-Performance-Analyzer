...
# ─────────────────────────────────────────────
# 2. GLOBAL CSS — CLEAN ADAPTIVE THEME (NO ICON BUG)
# ─────────────────────────────────────────────
st.markdown("""
    <style>
    ...
    /* ── MINIMAL: Hanya styling element tertentu, JANGAN universal selector ── */
    .block-container { 
        padding: 1.5rem 2rem 2rem 2rem !important; 
    }

    /* ── Sidebar (AMAN, tidak mengganggu toggle) ── */
...
# Skema warna aman kontras tinggi untuk Light dan Dark Mode
CLUSTER_META = {
...
def get_plotly_theme():
    """Mengatur tema visualisasi grafik Plotly agar sinkron dengan mode terang/gelap"""
